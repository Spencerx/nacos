...
import static com.alibaba.nacos.sys.env.EnvUtil.FUNCTION_MODE_SIMPLE;
...
public class ConfigEnabledFilter implements NacosPackageExcludeFilter {
    ...
    public boolean isExcluded(String className, Set<String> annotationNames) {
        ...
        return !FUNCTION_MODE_CONFIG.equals(functionMode) && !FUNCTION_MODE_SIMPLE.equals(functionMode);
    }
}
